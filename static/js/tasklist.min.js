...
}updateTimeElapsed(){if(this.props.taskdata.starttimestamp!=null&&this.props.taskdata.finishtimestamp==null){var starttime=new Date(this.props.taskdata.starttimestamp).getTime();var timeelapsed=(new Date().getTime()-starttime)/1000;this.setState({"timeelapsed":timeelapsed.toFixed(0)})}else if(this.state.interval!=null){clearInterval(this.state.interval);this.setState({"interval":null})}}shouldComponentUpdate(nextProps,nextState){if(nextProps.taskdata.starttimestamp!=null&&nextProps.taskdata.finishtimestamp==null){return true}if(JSON.stringify(nextProps)!=JSON.stringify(this.props)){return true}return false}render(){var task=this.props.taskdata;var statusclass="none";var buttontext="none";if(task.finishtimestamp!=null){statusclass="finished";buttontext="Delete"}else if(task.starttimestamp!=null){statusclass="queued started";buttontext="Cancel"}else{statusclass="queued notstarted";buttontext="Cancel"}console.log("Task "+task.id+" rendered");var delbutton=null;if(task.user_id==user_id){delbutton=/*#__PURE__*/React.createElement("button",{className:"btn btn-sm btn-danger",onClick:()=>this.deleteTask()},buttontext)}var taskbox=[/*#__PURE__*/React.createElement("div",{key:"rightside",className:"rightside"},delbutton,/*#__PURE__*/React.createElement("img",{src:task.previewimage_url,style:{display:"block",marginTop:"1em",marginLeft:"1em"}}))];taskbox.push(/*#__PURE__*/React.createElement("div",{key:"tasknum"},/*#__PURE__*/React.createElement("a",{key:"tasklink",href:task.url,onClick:e=>{this.props.setSingleTaskView(e,task.id,task.url)}},"Task ",task.id)));if(task.parent_task_url){taskbox.push(/*#__PURE__*/React.createElement("p",{key:"imgrequest"},"Image request for ",/*#__PURE__*/React.createElement("a",{key:"parent_task_link",href:task.parent_task_url,onClick:e=>{this.props.setSingleTaskView(e,task.parent_task_id,task.parent_task_url)}},"Task ",task.parent_task_id)))}else if(task.parent_task_id){taskbox.push(/*#__PURE__*/React.createElement("p",{key:"imgrequest"},"Image request for Task ",task.parent_task_id," (deleted)"))}else if(task.request_type=="IMGZIP"){taskbox.push(/*#__PURE__*/React.createElement("p",{key:"imgrequest"},"Image request"))}if(task.request_type=="IMGZIP"){var imagetype=task.use_reduced?"reduced":"difference";taskbox.push(/*#__PURE__*/React.createElement("p",{key:"imgrequestnote"},"Up to the first 500 ",imagetype," images will be retrieved. The image request and download link may expire after one week."))}if(task.user_id!=user_id){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"user"},"User: ",task.username))}if(task.comment!=null&&task.comment!=""){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"comment"},"Comment: ",/*#__PURE__*/React.createElement("b",null,task.comment)))}if(task.mpc_name!=null&&task.mpc_name!=""){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"target"},"MPC Object: ",task.mpc_name))}else{var radecepoch="";if(task.radec_epoch_year!=null){radecepoch=/*#__PURE__*/React.createElement("span",null,"(epoch ",task.radec_epoch_year,") ")}taskbox.push(/*#__PURE__*/React.createElement("div",{key:"target"},"RA Dec: ",radecepoch,task.ra," ",task.dec));if(task.propermotion_ra>0||task.propermotion_dec>0){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"propermotion"},"Proper motion [mas/yr]: ",task.propermotion_ra," ",task.propermotion_dec))}}taskbox.push(/*#__PURE__*/React.createElement("div",{key:"imgtype"},"Images: ",task.use_reduced?"Reduced":"Difference"));if(task.mjd_min!=null||task.mjd_max!=null){var mjdmin=task.mjd_min!=null?task.mjd_min:"0";var mjdmax=task.mjd_max!=null?task.mjd_max:"\u221E";taskbox.push(/*#__PURE__*/React.createElement("div",{key:"mjdrange"},"MJD request: [",mjdmin,", ",mjdmax,"]"))}taskbox.push(/*#__PURE__*/React.createElement("div",{key:"queuetime"},"Queued at ",new Date(task.timestamp).toLocaleString()));if(task.finishtimestamp!=null){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"status"},"Finished at ",new Date(task.finishtimestamp).toLocaleString()));if(task.error_msg!=null){taskbox.push(/*#__PURE__*/React.createElement("p",{key:"error_msg",style:{color:"black",fontWeight:"bold",marginTop:"1em"}},"Error: ",task.error_msg))}else{if(task.request_type=="FP"){taskbox.push(/*#__PURE__*/React.createElement("a",{key:"datalink",className:"results btn btn-info getdata",href:task.result_url,target:"_blank"},"Data"));taskbox.push(/*#__PURE__*/React.createElement("a",{key:"pdflink",className:"results btn btn-info getpdf",href:task.pdfplot_url,target:"_blank"},"PDF"))}if(task.request_type=="IMGZIP"){if(task.result_imagezip_url!=null){taskbox.push(/*#__PURE__*/React.createElement("a",{key:"imgdownload",className:"results btn btn-info",href:task.result_imagezip_url},"Download images (ZIP)"))}else{taskbox.push(/*#__PURE__*/React.createElement("p",null,"The download link has expired. Delete this task and request again if necessary."))}}else if(task.imagerequest_task_id!=null){if(task.imagerequest_finished){taskbox.push(/*#__PURE__*/React.createElement("a",{key:"imgrequest",className:"btn btn-primary",href:task.imagerequest_url,onClick:e=>{this.props.setSingleTaskView(e,task.imagerequest_task_id,task.imagerequest_url)}},"Images retrieved"))}else{taskbox.push(/*#__PURE__*/React.createElement("a",{key:"imgrequest",className:"btn btn-warning",href:task.imagerequest_url,onClick:e=>{this.props.setSingleTaskView(e,task.imagerequest_task_id,task.imagerequest_url)}},"Images requested"))}}else if(user_id==task.user_id){taskbox.push(/*#__PURE__*/React.createElement("button",{key:"imgrequest",className:"btn btn-info",onClick:()=>this.requestImages(),title:"Download FITS and JPEG images for up to the first 500 observations."},"Request ",task.use_reduced?"reduced":"diff"," images"))}}}else if(task.starttimestamp!=null){taskbox.push(/*#__PURE__*/React.createElement("div",{key:"status",style:{color:"red",fontStyle:"italic",marginTop:"1em"}},"Running (started ",this.state.timeelapsed," seconds ago)"))}else{taskbox.push(/*#__PURE__*/React.createElement("div",{key:"status",style:{fontStyle:"italic",marginTop:"1em"}},"Waiting (",task.queuepos," tasks ahead of this one)"))}if(task.finishtimestamp!=null&&task.error_msg==null&&task.request_type=="FP"&&!this.props.hidePlot){taskbox.push(/*#__PURE__*/React.createElement(TaskPlot,{key:"plot",taskid:task.id,taskurl:task.url}))}return/*#__PURE__*/React.createElement("li",{key:"task-"+task.id,className:"task "+statusclass,id:"task-"+task.id},taskbox)}}
"use strict";var jslcdataglobal=new Object;var jslabelsglobal=new Object;var jslimitsglobal=new Object;var tasklist_api_request_active=false;var tasklist_fetchcache=[];var tasklist_api_error="";class Pager extends React.PureComponent{constructor(props){super(props);this.state={};if(this.props.previous!=null){this.state.previous_cursor=new URL(this.props.previous).searchParams.get("cursor")}if(this.props.next!=null){this.state.next_cursor=new URL(this.props.next).searchParams.get("cursor")}}// componentWillReceiveProps(nextProps) {
