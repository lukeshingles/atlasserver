...
if(!jslimitsglobal[locallcdivname]||!jslcdataglobal[locallcdivname]||!document.getElementById(locallcdivname.replace("#",""))){return}// Always refer to the external data via the global variable and lcdivname.
...
if(!locallcdivname.includes("forced")){layout["xaxis2"]={tickformat:".0f",overlaying:"x",zeroline:false,side:"top",hoverformat:".5f",range:[x2min,x2max],title:"days since earliest detection"}}Plotly.react(locallcdivname.replace("#",""),data,layout,{displayModeBar:false,responsive:true})})();
