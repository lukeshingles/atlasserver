"use strict";let submission_in_progress=false;function getDefaultMjdMin(){return(mjdFromDate(new Date)-30).toFixed(5)}class NewRequest extends React.Component{get_defaultstate(){// localStorage.getItem('') will be null if the key doesn't exist and null != false,
