"use strict";import React from"react";let submission_in_progress=false;function getDefaultMjdMin(){return(mjdFromDate(new Date)-30).toFixed(5)}function errortext(value){// DRF error values can be strings, lists of strings, or nested objects (a field validator
...
const shownerrorkeys=["radeclist","mjd_max"];const remainingerrors=Object.entries(this.state.errors).filter(([key])=>!shownerrorkeys.includes(key));if(remainingerrors.length>0){formcontent.push(/*#__PURE__*/React.createElement("ul",{key:"othererrors",className:"errorlist"},remainingerrors.map(([key,value])=>/*#__PURE__*/React.createElement("li",{key:key},key=="non_field_errors"?"":key+": ",errortext(value)))))}const submitclassname=submission_in_progress?"btn btn-info submitting":"btn btn-info";const submitvalue=submission_in_progress?"Requesting...":"Request";formcontent.push(/*#__PURE__*/React.createElement("input",{key:"submitbutton",className:submitclassname,id:"submitrequest",type:"submit",value:submitvalue}));if(this.state.httperror!=""){formcontent.push(/*#__PURE__*/React.createElement("p",{key:"httperror",style:{"color":"red"}},this.state.httperror))}return/*#__PURE__*/React.createElement("div",{key:"newrequestcontainer",id:"newrequestcontainer"},/*#__PURE__*/React.createElement("div",{key:"newrequestsource",className:"newrequest",id:"newrequestsource"},/*#__PURE__*/React.createElement("div",{key:"newtask",className:"task"},/*#__PURE__*/React.createElement("h2",{key:"newtaskheader"},"New request"),/*#__PURE__*/React.createElement("form",{key:"newtaskform",id:"newrequest",onSubmit:this.onSubmit.bind(this)},formcontent))))}}
