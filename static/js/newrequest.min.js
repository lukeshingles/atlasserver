"use strict";import React from"react";let submission_in_progress=false;function getDefaultMjdMin(){return(mjdFromDate(new Date)-30).toFixed(5)}export class NewRequest extends React.Component{get_defaultstate(){// localStorage.getItem('') will be null if the key doesn't exist and null != false,
