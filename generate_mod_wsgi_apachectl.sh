...
mod_wsgi-express setup-server --working-directory atlasserver --url-alias /sne/atlasforced/static static --application-type module atlasserver.wsgi --server-root /tmp/atlasforced --port 8086 --mount-point /sne/atlasforced
